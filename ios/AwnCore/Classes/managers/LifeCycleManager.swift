...
public class LifeCycleManager:
    ...
    private lazy var listeners = [LocalLifeCycleEventListener]()
    
    public func subscribe(listener:LocalLifeCycleEventListener) -> Self {
    ...
    public func unsubscribe(listener:LocalLifeCycleEventListener) {
