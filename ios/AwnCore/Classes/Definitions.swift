public enum Definitions {
    public static let  USER_DEFAULT_TAG = "group.LocalNotifications." + Bundle.main.getBundleName()
    ...
    public static let  IOS_BACKGROUND_SCHEDULER = "local_notifications.scheduler"
    
    public static let  BROADCAST_CREATED_NOTIFICATION = "broadcast.local_notifications.CREATED_NOTIFICATION"
    public static let  BROADCAST_DISPLAYED_NOTIFICATION = "broadcast.local_notifications.DISPLAYED_NOTIFICATION"
    public static let  BROADCAST_DISMISSED_NOTIFICATION = "broadcast.local_notifications.DISMISSED_NOTIFICATION"
    public static let  BROADCAST_SILENT_ACTION = "broadcast.local_notifications.SILENT_ACTION"
    public static let  BROADCAST_DEFAULT_ACTION = "broadcast.lcoal_notifications.DEFAULT_ACTION"
    public static let  BROADCAST_BACKGROUND_ACTION = "broadcast.lcoal_notifications.BACKGROUND_ACTION"
    public static let  EXTRA_BROADCAST_MESSAGE = "notification"
 
    public static let  ACTION_HANDLE = "actionHandle"
    public static let  SILENT_HANDLE = "localSilentHandle"
    public static let  BACKGROUND_HANDLE = "localDartBGHandle"
    ...
    public static let  CHANNEL_FLUTTER_PLUGIN = "local_notifications"
    public static let  DART_REVERSE_CHANNEL = "local_notifications_reverse"
    ...
    public static let  LOCAL_EXTENSION_CLASS_NAME = "extensionClass"
    public static let  LOCAL_LAST_DISPLAYED_DATE = "lastDisplayedDate"
