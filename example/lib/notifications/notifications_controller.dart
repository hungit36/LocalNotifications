import 'package:local_push_notifications_example/main_complete.dart';
import 'package:local_push_notifications_example/routes/routes.dart';
import 'package:local_push_notifications_example/utils/common_functions.dart' if (dart.library.html)
'package:local_push_notifications_example/utils/common_web_functions.dart';
...
class NotificationsController {
  ...
  static Future<void> onActionReceivedMethod(
    ...
    switch (receivedAction.channelKey) {
      ...
      default:
        ...
        if (!LocalStringUtils.isNullOrEmpty(receivedAction.buttonKeyInput)) {
  ...
  static Future<void> interceptInitialCallActionRequest() async {
    ReceivedAction? receivedAction = await LocalNotifications()
