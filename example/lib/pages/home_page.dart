...
import 'package:local_push_notifications_example/common_widgets/led_light.dart';
import 'package:local_push_notifications_example/common_widgets/seconds_slider.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:fluttertoast/fluttertoast.dart';
import 'package:local_push_notifications/local_notifications.dart';

import 'package:local_push_notifications_example/routes/routes.dart';
import 'package:local_push_notifications_example/notifications/notifications_util.dart';

import 'package:local_push_notifications_example/common_widgets/check_button.dart';
import 'package:local_push_notifications_example/common_widgets/remarkble_text.dart';
import 'package:local_push_notifications_example/common_widgets/simple_button.dart';
import 'package:local_push_notifications_example/common_widgets/text_divisor.dart';
import 'package:local_push_notifications_example/common_widgets/text_note.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  String packageName = 'com.khohatsi.local_push_notifications_example';
  ...
  Future<void> refreshPermissionsIcons() async {
    LocalNotifications().isNotificationAllowed().then((isAllowed) async {
      setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Image.asset(
              'assets/images/local-notifications-logo-color.png',
          ...
          children: <Widget>[
            ...
            SimpleButton('Show notification from Json Data',
                onPressed: () => NotificationUtils.showNotificationFromJson({
                      "content": {
                        ...
                        "payload": {"secret": "Lcoal Notifications Rocks!"}
                      },
                      "actionButtons": [
                        {
                          "key": "REDIRECT",
                        ...
                        builder: (_) => AlertDialog(
                            ...
                            content: SizedBox(
                                ...
                                child: Center(
                                    child: Column(
                                  children: [
                                    Text(LocalDateUtils.parseDateToString(
                                        DateTime.now())!),
                                    Text(timeZone),
                                  ],
                                ))))))),
            ...
            SimpleButton('Get next Monday after date', onPressed: () async {
              ...
              NotificationSchedule schedule = NotificationCalendar(
                  ...
                  minute: 0,
                  second: 0,
                  timeZone: LocalNotifications.localTimeZoneIdentifier);
              //NotificationCalendar.fromDate(date: expectedDate);

              DateTime? nextValidDate = await LocalNotifications()
              ...
              if (nextValidDate == null) {
                ...
                response = LocalDateUtils.parseDateToString(
                    nextValidDate.toUtc(),
                    format: 'dd/MM/yyyy')!;
              }
