...
/// An implementation of [LocalNotificationsPlatform] that uses method channels.
class MethodChannelLocalNotifications extends LocalNotificationsPlatform {
  final String tag = 'MethodChannelLocalNotifications';
  ...
  final String _silentBGActionTypeKey =
      LocalAssertUtils.toSimpleEnumString(ActionType.SilentBackgroundAction)!;
  ...
  List<NotificationPermission> _listStringToListPermission(
    ...
    for (final permission in permissionList) {
      NotificationPermission? permissionValue =
          LocalAssertUtils.enumToString<NotificationPermission>(
