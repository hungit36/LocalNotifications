...
class LocalNotificationsEmpty extends LocalNotificationsPlatform
  ...
  Future<String> getLocalTimeZoneIdentifier() async {
    return LocalNotifications.localTimeZoneIdentifier;
  }
  ...
  Future<String> getUtcTimeZoneIdentifier() async {
    return LocalNotifications.utcTimeZoneIdentifier;
  }
