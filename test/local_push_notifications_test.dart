...
import 'package:local_push_notifications/local_notifications_platform_interface.dart';
...
void main() {
  final LocalNotificationsPlatform initialPlatform = LocalNotificationsPlatform.instance;

  test('$MethodChannelLocalNotifications is the default instance', () {
    expect(initialPlatform, isInstanceOf<MethodChannelLocalNotifications>());
  });

  test('getPlatformVersion', () async {
    LocalNotifications awesomeNotificationsPlugin = LocalNotifications();
    MockAwesomeNotificationsPlatform fakePlatform = MockAwesomeNotificationsPlatform();
    LocalNotificationsPlatform.instance = fakePlatform;
